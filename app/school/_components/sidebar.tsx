...
const navLinks: NavLink[] = [
  ...
  },
  {
    ...
    icon: <User2Icon className="size-4 mr-2" />,
    label: "Students",
    isRestricted: false,
  },
  {
    path: "/school/groups",
    icon: <Users2Icon className="size-4 mr-2" />,
    label: "Groups",
    isRestricted: false,
  },
  // {
  ...
  {
    path: "/school/courses",
    icon: <BookAIcon className="size-4 mr-2" />,
    label: "Courses",
    isRestricted: true,
  },
  {
    path: "/school/teachers",
    icon: <GraduationCapIcon className="size-4 mr-2" />,
    label: "Teachers",
    isRestricted: true,
  },
  {
    path: "/school/enrollments",
    icon: <BookMarkedIcon className="size-4 mr-2" />,
    label: "Enrollments",
    isRestricted: false,
  },
  {
  ...
  },
  {
    ...
    icon: <DoorOpenIcon className="size-4 mr-2" />,
    label: "Classrooms",
    isRestricted: true,
  },
];
