...
export const DeleteTeacherButton = React.forwardRef<
  HTMLButtonElement,
  ButtonProps
>(({ className, teacherId, buttonType, asChild = false, ...props }, ref) => {
...
DeleteTeacherButton.displayName = "DeleteTeacherButton";
